...
.PARAMETER Clean
Removes the image todonotificationjob and kills all containers based on that image.
...
Build a Docker image named todonotificationjob
#>
...
$imageName="todonotificationjob"
$projectName="todonotificationjob"
$serviceName="todonotificationjob"
